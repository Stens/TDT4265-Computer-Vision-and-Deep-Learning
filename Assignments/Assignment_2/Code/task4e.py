...
if __name__ == "__main__":
    ...
    train_history_ten, val_history_ten = trainer.train(
        num_epochs)
    print("---------", neurons_per_layer, "----------")
    print("Final Train Cross Entropy Loss:",
          cross_entropy_loss(Y_train, model.forward(X_train)))
    ...
    plot_metrics_loss(train_history_ten, val_history_ten, [
        "Loss (ten hidden layers)", "Accuracy (ten hidden layers)"], use_val=True)
    ...
    plot_metrics_acc(train_history_single, val_history_single, [
        "Loss (single hidden layer)", "Accuracy (single hidden layer)"], use_val=True)
    plot_metrics_acc(train_history_ten, val_history_ten, [
        "Loss (ten hidden layers)", "Accuracy (ten hidden layers)"], use_val=True)
